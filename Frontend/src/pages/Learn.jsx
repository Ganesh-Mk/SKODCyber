...
const LearningPage = () => {
  ...
  const renderCourseCard = (course, index) => (
    <motion.div
      ...
      className="group bg-gray-800/90 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300 shadow-lg hover:shadow-cyan-400/20 h-[500px] flex flex-col"
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        <div className="flex justify-between items-start gap-4 mb-4">
          <motion.h3
            ...
            className="text-xl font-semibold text-gray-100 line-clamp-2 group-hover:text-cyan-400 transition-colors duration-300 h-14"
          >
            {course.title}
          </motion.h3>
          <motion.span
            ...
            className="px-3 py-1 bg-gray-700/50 backdrop-blur-sm rounded-full text-sm font-medium text-cyan-400 border border-gray-600/50 whitespace-nowrap flex-shrink-0"
          >
            {course.role}
          </motion.span>
        </div>
        ...
        <motion.p
          ...
          className="text-gray-400 line-clamp-3 text-sm leading-relaxed flex-grow mb-4"
        >
          {course.description}
        </motion.p>
        ...
        <motion.button
          ...
          className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white text-lg font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-cyan-500/25 mt-auto"
        >
          View Modules
        </motion.button>
      </div>
